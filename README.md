# Script para converter a planilha padrão de Inventário de Dados Pessoais (IDP) do Estado do RS em um **esboço** do Relatório de Impacto de Proteção de Dados (RIPD)
